...
velocityField = component( constant(3.14159265/314.0)*( constant(50.0)-yComponent(identity()) ) , constant(3.14159265/314.0)*( xComponent(identity()) - constant(50.0) ) , constant(0.0) )
