...
velocityLeVeque = velocityLeVeque * constant( math.cos( 2.0*3.14159265 * T / 3.0 ) )
cfdmap = gradientStretchCM( velocityLeVeque, DT, gsSteps )
...
cfdmap = PutInGrid( cfdmap, gridbox, Vector(0,0,0) )
