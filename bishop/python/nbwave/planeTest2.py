...
#nbstate["phi"] += bu.exp( -( bu.identity()*bu.identity() )/bu.constant( 0.01 )  ) * bu.constant(3.0)
nbstate["XE"] += bu.exp( -( bu.identity()*bu.identity() )/bu.constant( 0.001 )  ) * bu.constant(bu.Vector(0,1,0))
